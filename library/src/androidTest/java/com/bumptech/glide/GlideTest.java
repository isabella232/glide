...
public class GlideTest {
    ...
    public void testReceivesRecursiveThumbnails() {
        requestManager
                ...
                .into(target);
        verify(target, times(4)).onResourceReady(any(Drawable.class), any(GlideAnimation.class), anyBoolean());
    }
    ...
    public void testReceivesRecursiveThumbnailWithPercentage() {
        requestManager
                ...
                .into(target);
        verify(target, times(3)).onResourceReady(any(Drawable.class), any(GlideAnimation.class), anyBoolean());
    }
